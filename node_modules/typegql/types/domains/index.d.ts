...
export { InputObjectType, compileInputObjectType, inputObjectTypeRegistry, } from './inputObjectType';
...
export { SchemaRoot, Schema, schemaRootsRegistry, compileSchema, Query, Mutation, } from './schema';
