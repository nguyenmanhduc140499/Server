...
<html lang="en">
<head>
    <title>Code coverage report for domains/objectType/compiler/objectType.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">domains/objectType/compiler</a> objectType.ts
    </h1>
    <div class='clearfix'>
...
<a name='L61'></a><a href='#L61'>61</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GraphQLObjectType } from 'graphql';<span class="fstat-no" title="function not covered" ><span class="branch-3 cbranch-no" title="branch not covered" ></span></span>
impo<span class="cstat-no" title="statement not covered" >rt { ObjectTypeError, objectTypeRegistry } from '../index';</span>
<span class="cstat-no" title="statement not covered" ></span>
import {<span class="cstat-no" title="statement not covered" > compileAllFields<span class="cstat-no" title="statement not covered" >, fieldsRegistry } from '~/domains/field';</span></span>
import {<span class="cstat-no" title="statement not covered" ></span>
  createCachedThunk,
  ge<span class="cstat-no" title="statement not covered" >tClassWith</span>AllParentClasses,
} from '~/services/utils';
&nbsp;
