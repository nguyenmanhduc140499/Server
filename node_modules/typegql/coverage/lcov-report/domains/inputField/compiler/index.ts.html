...
<html lang="en">
<head>
    <title>Code coverage report for domains/inputField/compiler/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">domains/inputField/compiler</a> index.ts
    </h1>
    <div class='clearfix'>
...
<a name='L97'></a><a href='#L97'>97</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {
  ...
  Gr<span class="missing-if-branch" title="if path not taken" >I</span>aphQLNonNull,
} from '<span class="cstat-no" title="statement not covered" >graphql';</span>
...
function<span class="cstat-no" title="statement not covered" > getFinalInputFieldType(</span>
  target: Function,
  fieldName: string,
  forcedType?: any,
) {
...
function validateResolvedType(
  target: Function,
  fieldName: string,
  ty<span class="missing-if-branch" title="if path not taken" >I</span>pe: GraphQLType,
): type <span class="cstat-no" title="statement not covered" >is Graph</span>QLInputType {
  if (!isInputType(type)) {
