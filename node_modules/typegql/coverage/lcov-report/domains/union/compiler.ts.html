...
<html lang="en">
<head>
    <title>Code coverage report for domains/union/compiler.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">domains/union</a> compiler.ts
    </h1>
    <div class='clearfix'>
...
<a name='L87'></a><a href='#L87'>87</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
  ...
  return (value: any, context: any, info: any) =&gt; {
    for (let type of types) {
      if (type.isTypeOf &amp;&amp; type.isTypeOf(value, context, info)) {
        <span class="missing-if-branch" title="if path not taken" >I</span>return type;
...
function enhanceTypeResolver(
  ...
  re<span class="missing-if-branch" title="if path not taken" >I</span>turn (value, context, info) =&gt; {
    cons<span class="cstat-no" title="statement not covered" >t rawRes</span>olvedType = originalResolver(value, context, info);
