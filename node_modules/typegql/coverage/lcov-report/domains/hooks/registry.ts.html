...
<html lang="en">
<head>
    <title>Code coverage report for domains/hooks/registry.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">domains/hooks</a> registry.ts
    </h1>
    <div class='clearfix'>
...
<a name='L63'></a><a href='#L63'>63</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GraphQLResolveInfo } from 'graphql';
import { DeepWeakMap } from '~/services/utils';
import { HookError } from './error';
&nbsp;
export interface HookExecutorResolverArgs {
  source: any;
  ar<span class="missing-if-branch" title="if path not taken" >I</span>gs: { [argName: string]: any };
  contex<span class="cstat-no" title="statement not covered" >t: any;</span>
...
export i<span class="cstat-no" title="statement not covered" >nterface AllRegisteredHooks {</span>
