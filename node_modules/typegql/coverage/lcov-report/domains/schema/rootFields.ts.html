...
<html lang="en">
<head>
    <title>Code coverage report for domains/schema/rootFields.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">domains/schema</a> rootFields.ts
    </h1>
    <div class='clearfix'>
...
<a name='L72'></a><a href='#L72'>72</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Field, FieldOptions, compileFieldConfig } from '~/domains/field';
import {
  queryFieldsRegistry,
  mutationFieldsRegistry,
  schemaRootsRegistry,
} fr<span class="missing-if-branch" title="if path not taken" >I</span>om './registry';
import {<span class="branch-1 cbranch-no" title="branch not covered" > SchemaFieldError } from './error';</span>
<span class="cstat-no" title="statement not covered" ></span>
function validateRootSchemaField(targetInstance: Object, fieldName: string) {
  if (
    !(targetInstance as any)[fieldName] &amp;&amp;
    <span class="missing-if-branch" title="else path not taken" >E</span>!targetInstance.constructor.prototype[fieldName]
  ) {
    throw new SchemaFieldError(
<span class="cstat-no" title="statement not covered" >      targetInstance.constructor,</span>
      fieldName,
