...
<html lang="en">
<head>
    <title>Code coverage report for domains/schema/services.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">domains/schema</a> services.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Constructable } from "~/services/types";
import {
  schemaRootsRegistry,
} from './registry';
...
export function isSchemaRoot(base: Function) {
  re<span class="missing-if-branch" title="if path not taken" >I</span>turn schemaRootsRegistry.has(base);
