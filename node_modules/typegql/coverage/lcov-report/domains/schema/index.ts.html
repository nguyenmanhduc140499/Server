...
<html lang="en">
<head>
    <title>Code coverage report for domains/schema/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">domains/schema</a> index.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export {
  schemaRootsRegistry,
...
export function Schema(config: SchemaRootConfig = {}) {
  ...
  return <span class="fstat-no" title="function not covered" >SchemaR</span>oot(config);
