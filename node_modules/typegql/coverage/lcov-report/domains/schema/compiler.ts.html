...
<html lang="en">
<head>
    <title>Code coverage report for domains/schema/compiler.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">domains/schema</a> compiler.ts
    </h1>
    <div class='clearfix'>
...
<a name='L85'></a><a href='#L85'>85</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GraphQLSchema, GraphQLObjectType, GraphQLFieldConfig } from 'graphql';
import {
  queryFieldsRegistry,
...
&nbsp;
      ...
      allRootFields[fieldName] = fieldConfig;<span class="branch-0 cbranch-no" title="branch not covered" ></span>
...
&nbsp;
  return new GraphQLObjectType({
    name,<span class="branch-1 cbranch-no" title="branch not covered" ></span>
