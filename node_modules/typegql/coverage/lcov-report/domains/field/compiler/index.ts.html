...
<html lang="en">
<head>
    <title>Code coverage report for domains/field/compiler/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">domains/field/compiler</a> index.ts
    </h1>
    <div class='clearfix'>
...
<a name='L77'></a><a href='#L77'>77</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GraphQLFieldConfig, GraphQLFieldConfigMap } from 'graphql';
...
import {<span class="cstat-no" title="statement not covered" > validat</span>eNotInferableField } from './fieldType';
&nbsp;
export function compileFieldConfig(
  ta<span class="missing-if-branch" title="if path not taken" >I</span>rget: Function,
  fieldN<span class="cstat-no" title="statement not covered" >ame: string,</span>
): Graph<span class="cstat-no" title="statement not covered" >QLFieldC</span>onfig&lt;any, any, any&gt; {
