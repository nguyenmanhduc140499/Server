...
<html lang="en">
<head>
    <title>Code coverage report for domains/field/compiler/fieldType.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">domains/field/compiler</a> fieldType.ts
    </h1>
    <div class='clearfix'>
...
<a name='L65'></a><a href='#L65'>65</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
&nbsp;
  if (!resolvedType) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>  target,
      fi<span class="cstat-no" title="statement not covered" >eldName,</span>
...
export function inferTypeOrThrow(
  ...
  if<span class="missing-if-branch" title="else path not taken" >E</span> (!inferedType) {
    throw new FieldError(
      target,
<span class="cstat-no" title="statement not covered" >      fieldName,</span>
