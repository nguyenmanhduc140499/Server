...
<html lang="en">
<head>
    <title>Code coverage report for domains/field/compiler/services.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">domains/field/compiler</a> services.ts
    </h1>
    <div class='clearfix'>
...
<a name='L66'></a><a href='#L66'>66</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
import {
  ...
  queryFieldsRegistry,
  isSchemaRoot,
} fr<span class="missing-if-branch" title="if path not taken" >I</span>om '~/domains/schema';
...
): type <span class="cstat-no" title="statement not covered" >is GraphQLOutp</span>utType {
  if (!isOutputType(type)) {
    <span class="missing-if-branch" title="if path not taken" >I</span>throw new FieldError(
