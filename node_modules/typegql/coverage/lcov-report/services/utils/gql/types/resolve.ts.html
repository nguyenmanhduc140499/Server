...
<html lang="en">
<head>
    <title>Code coverage report for services/utils/gql/types/resolve.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">services/utils/gql/types</a> resolve.ts
    </h1>
    <div class='clearfix'>
...
<a name='L94'></a><a href='#L94'>94</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">20x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { isType, GraphQLType, GraphQLList, GraphQLNonNull } from 'graphql';
...
&nbsp;
  if<span class="missing-if-branch" title="else path not taken" >E</span> (objectTypeRegistry.has(input)) {
...
&nbsp;
  if<span class="missing-if-branch" title="else path not taken" >E</span> (!allowThunk || typeof input !== 'function') {
...
function<span class="cstat-no" title="statement not covered" > resolveListType(input: any[], preferInputT</span>ype = false): GraphQLType {
  if (input.length !== 1) {
    return;
  }
